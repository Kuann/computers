...
insert into computer (id,name,company_id) values (  1,'MacBook Pro 15.4 inch',1);
insert into computer (id,name,company_id) values (  2,'CM-2a',2);
insert into computer (id,name,company_id) values (  3,'CM-200',12);
insert into computer (id,name,company_id) values (  4,'CM-5e',23);
# --- !Downs
